...
export const metadata: Metadata = {
  ...
  description:
    'Websites, Google listings and local search for pressure washing, window cleaning, landscaping, cafés, salons and any local business — one monthly fee, first month free, no contract.',
