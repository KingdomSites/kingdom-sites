...
/* Own header — back to Kingdom Sites top left, section links that collapse
   into a hamburger on phones. Same shape as Ministry, casual tone. */

const SECTIONS = [
  { href: '#meetings', label: 'Meetings' },
  { href: '#materials', label: 'Materials' },
  { href: '#lead', label: 'Lead' },
  { href: '#pray', label: 'Pray now' },
...
export default function PrayerNav() {
    ...
    <header>
      <nav>
        <div className="brand-row">
          ...
          <div className="brand">Prayer</div>
        </div>
